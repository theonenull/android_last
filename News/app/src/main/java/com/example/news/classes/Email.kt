...
object Main {
    ...
    var myEmailAccount = "thenewsofapp@163.com"
    var myEmailPassword = "DQMWOISLNDMHBEWQ"

    // 发件人邮箱的 SMTP 服务器地址, 必须准确, 不同邮件服务器地址不同, 一般(只是一般, 绝非绝对)格式为: smtp.xxx.com
    // 网易163邮箱的 SMTP 服务器地址为: smtp.163.com
    var myEmailSMTPHost = "smtp.163.com"

    // 收件人邮箱（替换为自己知道的有效邮箱）
    var receiveMailAccount = "xxxxxxxxx@qq.com"
    ...
    fun main(args: Array<String>) {
        ...
        */
        ...
        // 3. 创建一封邮件
        val message: MimeMessage = createMimeMessage(session, myEmailAccount, receiveMailAccount)
    ...
    fun createMimeMessage(session: Session?, sendMail: String?, receiveMail: String?): MimeMessage {
        ...
        message.setFrom(InternetAddress(sendMail, "某宝网", "UTF-8"))
